    ...
    mapping = {
        "mappings": {
            "properties": {
                ...
                "device1_manufacturer_d_zip_code": {"type": "keyword"},
                "device1_lot_number": {"type": "keyword"},
                "device1_model_number": {"type": "keyword"},
                "device1_generic_name" : {"type": "text"},
                "device1_device_operator": {"type": "text"},
                "device1_manufacturer_d_name": {"type": "text"},
                "device1_device_name": {"type": "text"},
                "device1_medical_specialty_description": {"type": "text"},
                "device1_device_class": {"type": "keyword"},
                "device1_regulation_number": {"type": "keyword"},
                "device1_catalog_number": {"type": "keyword"},
                "device2_manufacturer_d_zip_code": {"type": "keyword"},
                "device2_lot_number": {"type": "keyword"},
                "device2_model_number": {"type": "keyword"},
                "device2_generic_name" : {"type": "text"},
                "device2_device_operator": {"type": "text"},
                "device2_manufacturer_d_name": {"type": "text"},
                "device2_device_name": {"type": "text"},
                "device2_medical_specialty_description": {"type": "text"},
                "device2_device_class": {"type": "keyword"},
                "device2_regulation_number": {"type": "keyword"},
                "device2_catalog_number": {"type": "keyword"},
                "device3_manufacturer_d_zip_code": {"type": "keyword"},
                "device3_lot_number": {"type": "keyword"},
                "device3_model_number": {"type": "keyword"},
                "device3_generic_name" : {"type": "text"},
                "device3_device_operator": {"type": "text"},
                "device3_manufacturer_d_name": {"type": "text"},
                "device3_device_name": {"type": "text"},
                "device3_medical_specialty_description": {"type": "text"},
                "device3_device_class": {"type": "keyword"},
                "device3_regulation_number": {"type": "keyword"},
                "device3_catalog_number": {"type": "keyword"},
